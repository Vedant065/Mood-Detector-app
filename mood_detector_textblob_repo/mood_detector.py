...
st.title("🧠 Mood Detector — Sentiment Analyzer (TextBlob)")
...
st.markdown("---")
st.markdown("**About:** This app uses TextBlob polarity for sentiment detection. It's a prototype — not a medical or clinical tool.")